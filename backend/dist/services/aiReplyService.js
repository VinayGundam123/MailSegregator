...
exports.initializeTrainingData = initializeTrainingData;
const openai_1 = __importDefault(require("openai"));
const trainingKnowledge_model_1 = __importDefault(require("../models/trainingKnowledge.model"));
...
async function retrieveSimilarKnowledge(queryEmbedding, topK = 3) {
    const allKnowledge = await trainingKnowledge_model_1.default.find({}).lean();
